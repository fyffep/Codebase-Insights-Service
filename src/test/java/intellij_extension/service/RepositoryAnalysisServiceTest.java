...
public class RepositoryAnalysisServiceTest
{
    ...
    //UNUSED: No longer needed since we only clone 1 branch at a time
//    @Test
//    public void attachBranchNameList_BranchesMasterDevelopment_Success() throws IOException, GitAPIException {
//        // Set up test data...
...
//        assertTrue(codebase.getBranchNameList().contains(MASTER_BRANCH));
...
//    }
    ...
    @Test
    public void attachCodebaseData_BranchSize_ViewModelControllerBranch() throws IOException, GitAPIException {
    ...
    // Active branches will have a changing branch size.
    @Test
    public void attachCodebaseData_BranchSize_UIDevelopmentCommitHistory() throws IOException, GitAPIException {
    ...
    @Test
    public void attachCodebaseData_FileHeatMetrics_CodebaseInsightsToolWindowFactory() throws IOException, GitAPIException {
    ...
    @Test
    public void extractDataToCodebase_FileHeatMetrics_TestData() throws IOException, GitAPIException {
    ...
    @Test
    public void extractDataToCodebase_FileHeatMetrics_CodeBaseObservable() throws IOException, GitAPIException {
