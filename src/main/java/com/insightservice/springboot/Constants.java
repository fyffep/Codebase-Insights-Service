...
{
    public static final Logger LOG = LoggerFactory.getLogger(Main.class); // TODO This should probably change to a more reasonable class?
    ...
    public static final String USE_DEFAULT_BRANCH = "master";
...
//    public static final Border BORDER = new Border(new BorderStroke(Color.rgb(70, 70, 70),
